...
public class ApiHelper {
    ...
    public static void isReadContactsAllowed(Context context,
                                             CallBack callBack) {
    ...
    public static void isSendSmsAllowed(Context context,
                                             CallBack callBack) {
        if (ContextCompat.checkSelfPermission(context,
    ...
    public static void isWritStorageAllowed(Context context,
                                      CallBack callBack) {
        if (ContextCompat.checkSelfPermission(context,
    ...
    public static void isReadStorageAllowed(Context context,
                                            CallBack callBack) {
        if (ContextCompat.checkSelfPermission(context,
    ...
    public static void isLocationAllowed(Context context,
                                         CallBack callBack) {
        if (ContextCompat.checkSelfPermission(context,
