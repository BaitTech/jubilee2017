...
public final class PreConditions {
    ...
    /**
     * Ensures that {@code index} specifies a
     * valid <i>element</i> in an array, list or string of size
     * {@code size}. An element index may range
     * from zero, inclusive, to {@code size}, exclusive.
     *
     * @param index a user-supplied index
     ...
     *              this index in an error message
     * @return the value of {@code index}
     * @throws IndexOutOfBoundsException if
     *                                   {@code index}
     *                                   is negative or is not
     ...
     * list or string of
     * size {@code size}. A position index may
     ...
     * {@code size}, inclusive.
     *
     * @param start a user-supplied index
     *              identifying a starting position in
     *              an array, list or string
     * @param end   a user-supplied index
    ...
    private static String badPositionIndexes(int start,
        ...
        // end < start
        return format("end index (%s) must not be l" +
                        "ess than start index (%s)",
                end,
                start);
    }
